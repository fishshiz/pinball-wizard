import Matter from 'Matter-js';
  ...
  export const paddles = function paddles() {
    let leftPaddle = Bodies.trapezoid(190, 540, 20, 70, 0.25, { label: 'leftPaddle', angle: (2 * Math.PI)/3, chamfer: { radius: 10 }, isSleeping: false, render: { fillStyle: COLORS.PADDLE }});
   ...
   let rightPaddle = Bodies.trapezoid(300, 540, 20, 70, 0.25, { label: 'rightPaddle', angle: (4 * Math.PI)/3, chamfer: { radius: 10 },  sSleeping: false, render: { fillStyle: COLORS.PADDLE }});
